...
export default connect(mstp, {
  setChoisedStreet, setChoisedHouse, setChoisedHouseFlats,
  getStreets, getHouse, getHouseFlats,
  getClients, postNewClient, deleteThisClient, putThisClient
